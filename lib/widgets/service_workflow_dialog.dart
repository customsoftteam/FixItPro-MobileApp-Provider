...
class ServiceWorkflowDialog extends StatefulWidget {
  const ServiceWorkflowDialog({
    super.key,
  ...
  @override
  State<ServiceWorkflowDialog> createState() => _ServiceWorkflowDialogState();
}

class _ServiceWorkflowDialogState extends State<ServiceWorkflowDialog> {
  ...
  bool get _canPauseService {
    return _workflow?.status == 'in_progress';
  }

  bool get _canResumeService {
    return _workflow?.status == 'paused';
  }
  ...
  bool get _canSendOtp {
    return _workflow?.status == 'in_progress' && _allStepsCompleted;
  }
        ...
        child: Padding(
          ...
          child: _loading
              ...
              : Column(
                  ...
                  children: [
                    Text('Service Workflow • ${widget.bookingCode}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
        ...
        children: [
          ...
          if (_canVerifyOtp) ...[
            ...
            Container(
              ...
              child: Text(
                _demoOtp.isNotEmpty
                    ? 'Demo OTP is $_demoOtp'
                    : 'OTP has been sent. Enter customer OTP to complete.',
              ),
            ),
            const SizedBox(height: 10),
            TextField(
